...
public enum IndexConfigTypeEnum {
    ...
    public static com.kenny.mall.common.IndexConfigTypeEnum getIndexConfigTypeEnumByType(int type) {
        for (com.kenny.mall.common.IndexConfigTypeEnum indexConfigTypeEnum : com.kenny.mall.common.IndexConfigTypeEnum.values()) {
